...
This repository, [`allocativeharm`](https://github.com/etchin/allocativeharm), contains reproducible code for our manuscript, [`Potential for allocative harm in an environmental justice data tool`](http://arxiv.org/abs/2304.05603).
